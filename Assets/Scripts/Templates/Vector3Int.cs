...
namespace GameServer.Core
{
    ...
    public struct Vector3Int : IEquatable<Vector3Int>
    {
        ...
        {
            return new Vector3Int(MathUtil.FloorToInt(v.x), MathUtil.FloorToInt(v.y), MathUtil.FloorToInt(v.z));
        }
        ...
        {
            return new Vector3Int(MathUtil.CeilToInt(v.x), MathUtil.CeilToInt(v.y), MathUtil.CeilToInt(v.z));
        }
